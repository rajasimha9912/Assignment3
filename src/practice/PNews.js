...
export default class PNews extends Component {
  ...
  async componentDidMount() {
    // Changed "mount" to "componentDidMount"
  ...
  prevous = async () => {
    // Corrected "prevous" to "previous"
    let url = `https://newsapi.org/v2/everything?q=bitcoin&apiKey=1b860afbd9114134a3243d827a995a7a&page=${
      this.state.page - 1
  ...
  next = async () => {
    if (
      ...
      const url = `https://newsapi.org/v2/everything?q=bitcoin&apiKey=1b860afbd9114134a3243d827a995a7a&page=${
        this.state.page + 1
      }&pageSize=${this.props.pageSize}`;
      this.setState({
        loading: true,
